 ...
 *
 * [HAOTING CHEN] Modified from the crawler4j library code (crawler4j.CrawlController)
 */
    ...
    protected <T extends WebCrawler> void start(final Class<T> _c, final int numberOfCrawlers, boolean isBlocking, CrawlHandler handler) {
        try {
            ...
            for (int i = 1; i <= numberOfCrawlers; i++) {
                /** [HAOTING CHEN] Modified: transfer a parameter of an instance of CrawlHandler into the crawler for further operation */
